...
// Universal array for core foundational questions expected across all companies
...
const P = {
  arrays: [
    ...
    ["Maximum Product Subarray", 152, "M", ["O", "D", "T", "B", "S", "L"]],
    ["Find Minimum in Rotated Sorted Array", 153, "M", ["O", "D", "B", "C", "R"]],
    ...
    ["Find the Duplicate Number", 287, "M", ["O", "D", "L", "B", "R"]],
    ...
    ["Pascals Triangle", 118, "E", ["I", "A", "C", "R", "S"]],
    ["Spiral Matrix", 54, "M", ["O", "D", "R", "S", "B", "C"]],
    ["Set Matrix Zeroes", 73, "M", ["O", "D", "R", "C", "L", "B"]],
    ["Next Permutation", 31, "M", ["O", "D", "R", "S", "B", "C"]],
    ["Zero Array Transformation II", 3356, "M", ["R", "S", "B"]],
    ["Largest Number", 179, "M", ["O", "D", "R", "S", "C"]]
  ],
  strings: [
    ...
    ["Count and Say", 38, "M", ["I", "F", "C", "S"]],
    ["Find Index of First Occurrence", 28, "E", ["S", "L", "C", "B", "R"]],
    ["Repeated Substring Pattern", 459, "E", ["L", "S", "C"]],
    ["Rotate String", 796, "E", ["L", "C", "S", "R"]],
    ...
    ["Valid Word Abbreviation", 408, "E", ["R", "C", "S"]],
  ...
  hashmap: [
    ...
    ["Valid Sudoku", 36, "M", ["O", "S", "B", "R"]],
    ["Word Pattern", 290, "E", ["I", "A", "C", "L", "S"]],
    ["Happy Number", 202, "E", ["I", "F", "S", "C"]],
    ["4Sum II", 454, "M", ["O", "C", "B", "R"]],
    ["Contains Duplicate II", 219, "E", ["I", "L", "S", "C"]],
    ["Intersection of Two Arrays II", 350, "E", ["I", "F", "C", "S"]],
    ["Find the Difference", 389, "E", ["I", "S", "L", "C"]],
    ["Insert Delete GetRandom O(1)", 380, "M", ["B", "S", "R", "C"]],
  ],
  twoptr: [
    ["Remove Duplicates from Sorted Array", 26, "E", ALL],
    ["Remove Element", 27, "E", ALL],
    ["Merge Sorted Array", 88, "E", ALL],
    ["Squares of a Sorted Array", 977, "E", ["I", "A", "S", "C", "L"]],
    ["Backspace String Compare", 844, "E", ["I", "A", "S", "B", "C"]],
    ["Minimum Size Subarray Sum", 209, "M", ["O", "D", "S", "C", "R"]],
    ["3Sum Closest", 16, "M", ["O", "D", "S", "B", "C"]],
    ["4Sum", 18, "M", ["O", "D", "C", "R", "S"]],
  ...
  sliding: [
    ...
    ["Fruit Into Baskets", 904, "M", ["O", "L", "S", "C"]],
    ["Sliding Window Maximum", 239, "H", ["O", "D", "S", "B", "R", "C"]],
    ...
    ["Longest Repeating Character Replacement", 424, "M", ["D", "T", "B", "S", "L", "R"]],
    ["Count Number of Nice Subarrays", 1248, "M", ["O", "D", "C", "S", "R"]],
  ...
  ll: [
    ...
    ["Merge k Sorted Lists", 23, "H", ["O", "D", "S", "B", "R", "C"]],
    ["Reorder List", 143, "M", ["O", "D", "B", "S", "C", "R"]],
    ["Remove Duplicates from Sorted List", 83, "E", ["I", "A", "S", "L", "C"]],
    ["Rotate List", 61, "M", ["O", "D", "C", "S", "R"]],
    ["Sort List", 148, "M", ["O", "D", "T", "S", "C", "B"]],
    ["LRU Cache", 146, "M", ["B", "R", "S", "C", "O", "D"]],
    ["LFU Cache", 460, "H", ["B", "S", "R"]],
  ],
  stack: [
    ["Valid Parentheses", 20, "E", ALL],
    ["Min Stack", 155, "M", ALL],
    ["Implement Queue using Stacks", 232, "E", ["I", "A", "S", "C", "R"]],
    ["Implement Stack using Queues", 225, "E", ["I", "L", "C", "S"]],
    ["Daily Temperatures", 739, "M", ["O", "D", "T", "S", "C", "B", "R"]],
    ["Next Greater Element I", 496, "E", ALL],
    ["Next Greater Element II", 503, "M", ["O", "D", "S", "C", "R"]],
    ["Largest Rectangle in Histogram", 84, "H", ["O", "S", "B", "R", "C"]],
    ["Evaluate Reverse Polish Notation", 150, "M", ["O", "I", "S", "C", "R", "B"]],
    ["Remove All Adjacent Duplicates In String", 1047, "E", ["I", "A", "S", "L", "C"]],
    ["Basic Calculator II", 227, "M", ["O", "D", "S", "B", "C", "R"]],
  ...
  trees: [
    ...
    ["Sum of Left Leaves", 404, "E", ["I", "A", "S", "L", "C"]],
    ...
    ["Flatten Binary Tree to Linked List", 114, "M", ["O", "D", "S", "B", "C", "R"]],
    ["Path Sum II", 113, "M", ["O", "D", "S", "C", "R"]],
    ["Maximum Width of Binary Tree", 662, "M", ["O", "D", "S", "B", "C"]],
    ...
    ["Subtree of Another Tree", 572, "E", ["B", "S", "L", "C"]],
  ...
  dp: [
    ...
    ["Edit Distance", 72, "H", ["B", "S", "C", "R", "O"]],
    ["Regular Expression Matching", 10, "H", ["B", "S", "R", "C"]],
  ],
  bt: [
  ...
  heap: [
    ...
    ["Reorganize String", 767, "M", ["O", "D", "S", "B", "C"]],
    ["Find Median from Data Stream", 295, "H", ["O", "S", "B", "R", "C"]],
    ["Kth Largest Element in a Stream", 703, "E", ["I", "F", "B", "S", "L", "C"]],
