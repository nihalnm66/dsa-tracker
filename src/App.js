...
const CO_CLR = {
  ...
  RX: { background: "#f3e8ff", color: "#6b21a8" }
};
...
const P = {
  arrays: [
    ["Two Sum", 1, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Best Time to Buy and Sell Stock", 121, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Contains Duplicate", 217, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Maximum Subarray", 53, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["Product of Array Except Self", 238, "M", ["O", "A", "D", "T", "B", "R", "RX"]],
    ...
    ["3Sum", 15, "M", ["O", "A", "D", "T", "B", "R", "RX"]],
    ["Container With Most Water", 11, "M", ["O", "A", "D", "B", "R", "RX"]],
    ["Subarray Sum Equals K", 560, "M", ["O", "I", "A", "D", "T", "F"]],
    ["Majority Element", 169, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ...
    ["Merge Intervals", 56, "M", ["O", "D", "T", "R", "RX"]],
    ["Insert Interval", 57, "M", ["O"]],
    ["Meeting Rooms II", 253, "M", ["T", "A"]],
    ["Pascals Triangle", 118, "E", ["I", "A"]],
    ["Spiral Matrix", 54, "M", ["O", "D", "R", "RX"]],
    ["Set Matrix Zeroes", 73, "M", ["O", "D", "R", "RX"]],
    ["Next Permutation", 31, "M", ["O", "D", "R", "RX"]],
    ["Zero Array Transformation II", 3356, "M", ["R", "RX"]],
    ["Largest Number", 179, "M", ["R", "RX"]],
    ["Check if One String Swap Can Make Strings Equal", 1790, "E", ["RX"]],
    ["Count Unhappy Friends", 1583, "M", ["RX"]],
    ["Maximum Passengers on Blocked Grid (Custom Matrix DP)", 0, "H", ["RX"]],
  ],
  strings: [
    ["Valid Anagram", 242, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Valid Palindrome", 125, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Longest Common Prefix", 14, "E", ["O", "I", "A", "D", "T", "F", "RX"]],
    ["Longest Substring Without Repeating Characters", 3, "M", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Longest Palindromic Substring", 5, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["String to Integer Atoi", 8, "M", ["I", "A"]],
    ["Reverse Words in a String", 151, "M", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["First Unique Character in a String", 387, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Group Anagrams", 49, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["Find All Anagrams in a String", 438, "M", ["O", "D"]],
    ["Permutation in String", 567, "M", ["O", "D", "T"]],
    ["Minimum Window Substring", 76, "H", ["O", "D", "B", "R", "RX"]],
    ...
    ["Valid Parentheses", 20, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["Roman to Integer", 13, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Integer to Roman", 12, "M", ["O", "D"]],
    ["Count and Say", 38, "M", ["I", "F"]],
    ["Find Index of First Occurrence", 28, "E", ["R", "RX"]],
    ["String Compression", 443, "M", ["R", "RX"]],
    ["Group Shifted Strings", 249, "M", ["R", "RX"]],
    ["Shortest Word Distance II", 244, "M", ["R", "RX"]],
    ["Valid Word Abbreviation", 408, "E", ["R", "RX"]],
    ["Minimum Remove to Make Valid Parentheses", 1249, "M", ["R", "RX"]],
    ["Repeated String Match", 686, "M", ["RX"]],
    ["Maximum Number of Occurrences of a Substring", 1297, "M", ["RX"]],
    ["Guess the Word (Custom String Processing)", 0, "H", ["RX"]],
  ],
  hashmap: [
    ["Two Sum II Input Array Is Sorted", 167, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["Top K Frequent Elements", 347, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["Longest Consecutive Sequence", 128, "M", ["O", "A", "D", "B", "R", "RX"]],
    ["Valid Sudoku", 36, "M", ["O"]],
    ...
    ["Minimum Occurrence Character Search (Custom)", 0, "M", ["RX"]],
  ],
  twoptr: [
    ["Remove Duplicates from Sorted Array", 26, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["Remove Element", 27, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ["Merge Sorted Array", 88, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Squares of a Sorted Array", 977, "E", ["I", "A"]],
    ["Backspace String Compare", 844, "E", ["I", "A"]],
    ["Minimum Size Subarray Sum", 209, "M", ["O", "D", "RX"]],
    ["3Sum Closest", 16, "M", ["O", "D"]],
    ["4Sum", 18, "M", ["O", "D"]],
    ["Trapping Rain Water", 42, "H", ["O", "A", "D", "B", "R", "RX"]],
  ...
  sliding: [
    ...
    ["Longest Continuous Subarray With Absolute Diff Limit", 1438, "M", ["R", "RX"]],
    ["Max Sum of Distinct Subarrays With Length K", 2461, "M", ["R", "RX"]],
    ["Continuous Subarrays", 2762, "M", ["R", "RX"]],
    ["Longest Subarray of 1's After Deleting One Element", 1493, "M", ["R", "RX"]],
    ["Minimum Street Lights Coverage (Custom Interval Greedy)", 0, "H", ["RX"]],
    ["Moving Average from Data Stream", 346, "E", ["RX"]],
    ["Disk Space Analysis (Custom Sliding Window Minimum)", 0, "H", ["RX"]],
  ],
  ll: [
    ["Reverse Linked List", 206, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Merge Two Sorted Lists", 21, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Linked List Cycle", 141, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Linked List Cycle II", 142, "M", ["O", "D"]],
    ["Middle of the Linked List", 876, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Remove Nth Node From End of List", 19, "M", ["O", "I", "A", "D", "T", "F", "B", "RX"]],
    ["Palindrome Linked List", 234, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Intersection of Two Linked Lists", 160, "E", ["O", "I"]],
    ["Add Two Numbers", 2, "M", ["O", "D", "T", "B", "RX"]],
    ["Copy List with Random Pointer", 138, "M", ["O", "D", "B"]],
    ["Merge k Sorted Lists", 23, "H", ["O", "D", "RX"]],
    ["Reorder List", 143, "M", ["O", "D", "B", "RX"]],
    ["Remove Duplicates from Sorted List", 83, "E", ["I", "A"]],
    ["Rotate List", 61, "M", ["O", "D"]],
    ["Sort List", 148, "M", ["O", "D", "T"]],
    ["LRU Cache", 146, "M", ["B", "R", "RX"]],
    ["LFU Cache", 460, "H", ["B"]],
  ],
  stack: [
    ["Valid Parentheses", 20, "E", ["O", "I", "A", "D", "T", "F"]],
    ["Min Stack", 155, "M", ["O", "I", "A", "D", "T", "F", "RX"]],
    ["Implement Queue using Stacks", 232, "E", ["I", "A", "RX"]],
    ["Implement Stack using Queues", 225, "E", ["I"]],
    ["Daily Temperatures", 739, "M", ["O", "D", "T", "RX"]],
    ["Next Greater Element I", 496, "E", ["O", "I", "A", "D", "T", "F", "RX"]],
    ["Next Greater Element II", 503, "M", ["O", "D", "RX"]],
    ["Largest Rectangle in Histogram", 84, "H", ["O"]],
    ["Evaluate Reverse Polish Notation", 150, "M", ["O", "I"]],
    ["Remove All Adjacent Duplicates In String", 1047, "E", ["I", "A", "R", "RX"]],
  ...
  trees: [
    ["Maximum Depth of Binary Tree", 104, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ...
    ["Diameter of Binary Tree", 543, "E", ["O", "I", "A", "D", "T", "F", "R", "RX"]],
    ...
    ["Binary Tree Level Order Traversal", 102, "M", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Binary Tree Zigzag Level Order Traversal", 103, "M", ["O", "D"]],
    ["Binary Tree Right Side View", 199, "M", ["O", "A", "D", "B", "R", "RX"]],
    ["Lowest Common Ancestor of a Binary Search Tree", 235, "M", ["O", "I", "A", "D", "T", "F", "B"]],
    ["Lowest Common Ancestor of a Binary Tree", 236, "M", ["O", "D", "R", "RX"]],
    ...
    ["Convert Sorted List to Binary Search Tree", 109, "M", ["R", "RX"]],
    ["Sum Root to Leaf Numbers", 129, "M", ["R", "RX"]],
    ["Find Leaves of Binary Tree", 366, "M", ["R", "RX"]],
    ["Convert Binary Search Tree to Sorted Doubly Linked List", 426, "M", ["R", "RX"]],
  ],
  graphs: [
    ["Number of Islands", 200, "M", ["O", "A", "D", "T", "B", "R", "RX"]],
    ["Flood Fill", 733, "E", ["I", "A"]],
    ["Max Area of Island", 695, "M", ["O", "D", "T", "B"]],
    ["Rotting Oranges", 994, "M", ["O", "A", "D", "T", "B", "R", "RX"]],
    ["Find if Path Exists in Graph", 1971, "E", ["I", "F"]],
    ["Clone Graph", 133, "M", ["O", "D", "B", "RX"]],
    ["Course Schedule", 207, "M", ["O", "D", "B", "R", "RX"]],
    ["Course Schedule II", 210, "M", ["O", "B", "RX"]],
    ...
    ["Number of Distinct Islands", 694, "M", ["R", "RX"]],
    ["Minimum Time to Visit a Cell In a Grid", 2577, "H", ["R", "RX"]],
    ["Number of Islands II", 305, "H", ["RX"]],
  ],
  trie: [
    ["Implement Trie", 208, "M", ["B"]],
    ["Design Add and Search Words", 211, "M", ["B"]],
    ["Word Search II", 212, "H", ["B"]],
    ["Search Suggestions System", 1268, "M", ["R", "RX"]],
  ],
  uf: [
  ...
  dp: [
    ["Climbing Stairs", 70, "E", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["Min Cost Climbing Stairs", 746, "E", ["I", "A"]],
    ["Fibonacci Number", 509, "E", ["I", "A"]],
    ["House Robber", 198, "M", ["O", "I", "A", "D", "T", "F", "B", "R", "RX"]],
    ["House Robber II", 213, "M", ["O", "D"]],
    ["Jump Game", 55, "M", ["O", "D", "T"]],
    ["Jump Game II", 45, "M", ["O", "D"]],
    ["Coin Change", 322, "M", ["O", "A", "D", "T", "B", "R", "RX"]],
    ["Coin Change II", 518, "M", ["O", "D"]],
    ["Unique Paths", 62, "M", ["O", "A", "D"]],
    ["Unique Paths II", 63, "M", ["O"]],
    ["Minimum Path Sum", 64, "M", ["O", "D"]],
    ["Longest Increasing Subsequence", 300, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["Word Break", 139, "M", ["O", "D", "T", "R", "RX"]],
    ["Decode Ways", 91, "M", ["O", "T"]],
    ["Partition Equal Subset Sum", 416, "M", ["O", "D"]],
    ["Target Sum", 494, "M", ["O", "D"]],
    ["Perfect Squares", 279, "M", ["O", "D"]],
    ["Longest Common Subsequence", 1143, "M", ["B", "R", "RX"]],
    ["Edit Distance", 72, "H", ["B"]],
    ["Regular Expression Matching", 10, "H", ["B"]],
    ["Expression Add Operators", 282, "H", ["RX"]],
    ["Maximize Earnings (Custom Weighted Interval Scheduling)", 0, "H", ["RX"]],
    ["Maximize Amount After Two Days of Conversions", 3021, "H", ["RX"]],
    ["Minimum Operations to Make Character Frequencies Equal (Custom)", 0, "H", ["RX"]],
  ],
  bt: [
    ["Subsets", 78, "M", ["O", "D", "B", "R", "RX"]],
    ["Subsets II", 90, "M", ["O", "B"]],
    ["Permutations", 46, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["Permutations II", 47, "M", ["O"]],
    ["Combinations", 77, "M", ["O", "D"]],
    ["Combination Sum", 39, "M", ["O", "D", "T", "B", "R", "RX"]],
    ["Combination Sum II", 40, "M", ["O"]],
    ["Letter Combinations of a Phone Number", 17, "M", ["O", "A", "D"]],
    ["Word Search", 79, "M", ["O", "D", "B", "R", "RX"]],
    ["Palindrome Partitioning", 131, "M", ["O"]],
  ],
  heap: [
    ["Kth Largest Element in an Array", 215, "M", ["O", "D", "T", "B"]],
    ["K Closest Points to Origin", 973, "M", ["O", "D", "B", "R", "RX"]],
    ...
    ["Minimum Difference in Sums After Removal of Elements", 2163, "H", ["R", "RX"]],
  ],
  sort: [
  ...
  math: [
    ...
    ["Best Time to Buy and Sell Stock II", 122, "M", ["R", "RX"]],
    ["Gas Station", 134, "M", ["R", "RX"]],
    ["Split Array Largest Sum", 410, "H", ["R", "RX"]],
    ["Random Pick with Weight", 528, "M", ["R", "RX"]],
    ["Maximum Swap", 670, "M", ["R", "RX"]],
    ["The kth Factor of n", 1492, "M", ["R", "RX"]],
    ["FIFO Tax Calculation Simulation (Custom)", 0, "H", ["RX"]],
  ],
  matrix: [
    ["Rotate Image", 48, "M", ["O", "D", "R", "RX"]],
